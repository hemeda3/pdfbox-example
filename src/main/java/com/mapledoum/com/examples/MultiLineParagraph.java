...
/*
 ...
 it is printed on a single line. We need to calculate how many words will
 fit on a single line and then write the text to the document. We also wrote a feature
 to calculate the justified text which you can enable by passing a boolean argument.
...
public class MultiLineParagraph {
    ...
    public static void main(String... args)  {
        ...
        try (final PDDocument doc = new PDDocument()){
            ...
            doc.save(new File("target/example.pdf"));
        } catch (IOException e){
